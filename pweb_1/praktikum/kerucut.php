...
<html lang="en">
<head>
    <title>Menghitung Kerucut</title>
...
<body>
    <div class="container">
        <h2>Menghitung Luas dan Volume Kerucut</h2>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (is_numeric($jari) && $jari > 0 && is_numeric($tinggi) && $tinggi > 0) {
                ...
                $sisi = sqrt(pow($jari, 2) + pow($tinggi, 2)); // menghitung panjang sisi miring
                $luas = pi() * $jari * ($jari + $sisi); // luas permukaan
            } else {
